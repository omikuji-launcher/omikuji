...
fn main() {
    ...
    let app_settings_bridge = kushi::ObjectBridge::new("AppSettingsBridge")
        ...
        .prop_at("floating_bar_style", kushi::Kind::QString, "display.floating_bar_style")
        .prop_at("floating_bar_height", kushi::Kind::I32, "display.floating_bar_height")
        .prop_at("floating_bar_opaque", kushi::Kind::Bool, "display.floating_bar_opaque")
