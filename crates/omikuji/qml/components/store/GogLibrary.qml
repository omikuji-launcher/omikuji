    ...
    CardGrid {
        ...
        delegate: BaseCard {
            ...
            overlayComponent: Component {
                CardProgressOverlay {
                    readonly property var download: root.activeDownloads[gogCard.modelData.appName]
                    visible: gogCard.isDownloading && download !== undefined
                    bannerArea: gogCard.bannerArea
